...
class Loader
{
    use \oreadblog\Engine\Pattern\Singleton; // Thanks Trait feature of PHP 5.4, I don't duplicate pattern code
    ...
    private function _loadClasses($sClass)
    {
        ...
        $sClass = str_replace(array(__NAMESPACE__, 'oreadblog', '\\'), '/', $sClass);
